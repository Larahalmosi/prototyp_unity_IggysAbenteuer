...
[Range(1f, 50f)] public float MaxForce = 10f;
...
private class WaterPoint
 ...
 private void Awake() // NICHT Start!
    {
        _call = GetComponent<EdgeCollider2D>();
        _call.isTrigger = true;
    }
private void Start()
    {   GenerateMesh();
        CreateWaterPoints();
...
private void FixedUpdate()
    ...
    {   //Debug.Log("Edgyyyy");
        ...
        _call.offset = Vector2.zero;
        _call.points = newPoints;
